...
describe('Suíte de Testes Fortalecida para 50 Operações Aritméticas', () => {
  ...
  test('6. deve calcular a raiz quadrada e lançar erro para negativos', () => {
  ...
  test('8. deve calcular o fatorial (casos de borda e erro)', () => {
  ...
  test('9. deve calcular a média de um array (com e sem elementos)', () => {
  ...
  test('11. deve encontrar o valor máximo e lançar erro para array vazio', () => {
    expect(maximoArray([1, 50, 10])).toBe(50);
    expect(() => maximoArray([])).toThrow('Array vazio не possui valor máximo.');
  });

  test('12. deve encontrar o valor mínimo e lançar erro para array vazio', () => {
  ...
  test('15. deve retornar true para um número par (e false para ímpar)', () => {
    expect(isPar(100)).toBe(true);
    expect(isPar(7)).toBe(false);
  });

  test('16. deve retornar true para um número ímpar (e false para par)', () => {
  ...
  test('33. deve verificar que um número é primo (e casos de borda)', () => {
  ...
  test('35. deve calcular o produto de um array (com e sem elementos)', () => {
  ...
  test('37. deve verificar se um número é divisível (e não divisível)', () => {
    expect(isDivisivel(10, 2)).toBe(true);
    expect(isDivisivel(10, 3)).toBe(false);
  });

  test('38. deve converter Celsius para Fahrenheit (com 0 e 100)', () => {
    expect(celsiusParaFahrenheit(0)).toBe(32);
    expect(celsiusParaFahrenheit(100)).toBe(212);
  });

  test('39. deve converter Fahrenheit para Celsius (com 32 e 212)', () => {
    expect(fahrenheitParaCelsius(32)).toBe(0);
    expect(fahrenheitParaCelsius(212)).toBe(100);
  });

  test('40. deve calcular o inverso de um número (e lançar erro para 0)', () => {
  ...
  test('44. deve verificar se um número é maior que outro (e casos de borda)', () => {
    expect(isMaiorQue(10, 5)).toBe(true);
    expect(isMaiorQue(5, 10)).toBe(false);
    expect(isMaiorQue(5, 5)).toBe(false);
  });

  test('45. deve verificar se um número é menor que outro (e casos de borda)', () => {
    expect(isMenorQue(5, 10)).toBe(true);
    expect(isMenorQue(10, 5)).toBe(false);
    expect(isMenorQue(5, 5)).toBe(false);
  });

  test('46. deve verificar se dois números são iguais (e diferentes)', () => {
    expect(isEqual(7, 7)).toBe(true);
    expect(isEqual(7, 5)).toBe(false);
  });

  test('47. deve calcular a mediana de um array (ímpar, par, desordenado e vazio)', () => {
    expect(medianaArray([1, 2, 3, 4, 5])).toBe(3);
    expect(() => medianaArray([])).toThrow('Array vazio не possui mediana.');
    expect(medianaArray([10, 2, 5, 1, 7])).toBe(5);
    expect(medianaArray([10, 2, 5, 1, 7, 12])).toBe(6);
  });
